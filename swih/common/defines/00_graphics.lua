...
NGraphics = {
	...
	UNIT_TURN_SPEED = 3,
	WATER_MAP_MODE_COLOR_R = 0.0,
	WATER_MAP_MODE_COLOR_G = 0.0,
	WATER_MAP_MODE_COLOR_B = 0.0,
	...
	MOON_HEIGHT = 0, -- higher means softer shadows and more intense light
	SUN_HEIGHT  = 0, -- higher means softer shadows and more intense light
	...
	SUN_LATITUDE  = 0,
	SECOND_MOON_LATITUDE = 0, -- Used to put a "fake" sun/moon on the other side of the globe to hide the seem that would otherwise appear there
	SECOND_SUN_LATITUDE = 0,
	...
	SUN_DIFFUSE_COLOR   = {0.0, 0.0, 0.0},
	SUN_INTENSITY 		= 1.0; -- 0.4
	MOON_DIFFUSE_COLOR  = {0.0, 0.0, 0.0},
	MOON_INTENSITY 		= 0.0;
